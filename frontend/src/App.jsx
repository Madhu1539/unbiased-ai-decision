...
export default function App() {
  ...
  // On desktop (≥1024px) keep sidebar open by default; on mobile start closed
  useEffect(() => {
    ...
    <ThemeProvider>
      <div className="flex h-screen bg-surface-900 dark:bg-surface-900 overflow-hidden transition-colors duration-300">
        ...
        <div className="flex-1 flex flex-col overflow-hidden min-w-0">
          ...
          {/* ── Page Navigator ── */}
          <PageNavigator currentId={activePage} onNavigate={handleNavigate} />

          {/* ── Footer ── */}
          <footer className="bg-surface-800 dark:bg-surface-800 border-t border-surface-700 px-4 sm:px-6 py-2 flex flex-col sm:flex-row items-center justify-between gap-1 transition-colors duration-300">
            <p className="text-xs text-slate-500">
              Unbiased AI Decision Dashboard &copy; {new Date().getFullYear()}
            </p>
            <div className="flex items-center gap-2 sm:gap-3 text-xs text-slate-600 flex-wrap justify-center">
